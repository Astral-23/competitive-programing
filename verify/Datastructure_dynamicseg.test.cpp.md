...
data:
  ...
  bundledCode: "#line 1 \"verify/Datastructure_dynamicseg.test.cpp\"\n#define PROBLEM\
  ...
  verifiedWith: []
documentation_of: verify/Datastructure_dynamicseg.test.cpp
layout: document
redirect_from:
- /verify/verify/Datastructure_dynamicseg.test.cpp
- /verify/verify/Datastructure_dynamicseg.test.cpp.html
