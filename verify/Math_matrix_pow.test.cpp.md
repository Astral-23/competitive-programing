...
data:
  ...
  bundledCode: "#line 1 \"verify/Math_matrix_pow.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/pow_of_matrix\"\
    ...
    \        os << a[i][j] << (j != a.w - 1 ? \" \" : \"\");\n            }\n    \
    \        os << (i != a.h - 1 ? \"\\n\" : \"\");\n        }\n        return os;\n\
    \    }\n};\n#line 5 \"verify/Math_matrix_pow.test.cpp\"\nusing mint = modint998244353;\n\
    int main() {\n    ll N, K;\n    cin >> N >> K;\n    Matrix<mint> A(N, N, 0);\n\
    \    rep(i, 0, N) rep(j, 0, N) {\n        cin >> A[i][j];\n    }\n    A = A.pow(K);\n\
    \    rep(i, 0, N) {\n        rep(j, 0, N) {\n            cout << A[i][j].x <<\
    \ \" \";\n        }\n        cout << '\\n';\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/Math_matrix_pow.test.cpp
layout: document
redirect_from:
- /verify/verify/Math_matrix_pow.test.cpp
- /verify/verify/Math_matrix_pow.test.cpp.html
