...
data:
  ...
  bundledCode: "#line 1 \"verify/Datastructure_dsu.test.cpp\"\n#define PROBLEM \"\
  ...
  verifiedWith: []
documentation_of: verify/Datastructure_dsu.test.cpp
layout: document
redirect_from:
- /verify/verify/Datastructure_dsu.test.cpp
- /verify/verify/Datastructure_dsu.test.cpp.html
